...
const About: React.FC = (): ReactElement => {
    return (
        <div id="test" className="about">
            <p className="about-paragraph">I&apos;m a junior Data Science and Philosophy major at the University of Nebraska - Lincoln. Ever since I started coding on calculators in middle school, I fell in love with the world of programming. I love machine learning, cybersecurity, and systems engineering, and I&apos;m looking for roles in any of those fields with an emphasis on learning new skills.</p>
            <div className="quick-facts">
                ...
                <Info title="Skills" description="Python, TensorFlow, Ruby on Rails, Java, C, C#, PostgreSQL, R, React.js, Node.js" />
